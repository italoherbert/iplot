...
import italo.iplot.plot2d.g2d.util.corte.vertice.TrazVRCondicao;

public class TrazFaceCortador2D extends AbstractFaceCortador2D {
                    
    private final CorteCondicao cond = new TrazFrenteCorteCondicao();    
    private final CorteCondicao vrcond = new TrazVRCondicao();
